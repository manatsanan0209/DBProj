...
<body class="">
  ...
  <div class="w-3/5 h-max my-5 mx-auto p-2 grid grid-cols-2 gap-2">
    <a href="{{ route('waitpayment') }}" class="dark:text-blue-200 font-normal text-2xl text-center">Waiting for payment</a>
    <a href="{{ route('orders') }}" class="dark:text-white font-normal text-2xl text-center">Orders</a>
  ...
  <div class="bg-gray-200 w-4/6 h-max my-5 mx-auto rounded-xl p-10 grid grid-cols-4 gap-4">
    ...
    <div class="col-start-3 text-black-300 font-normal text-lg text-center "> บาท </div>
    <button type="submit" class="col-start-4 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-xl text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Pay Now</button>
  </div>
  @endforeach
  <!-- Footer -->
