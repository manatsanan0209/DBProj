...
<body class="">
    ...
    <div class="mx-auto w-full max-w-screen-xl h-full flex items-center justify-center">
        <div class="text-center bg-white p-12 rounded-lg w-1/3">
            ...
            <form class="max-w-sm mx-auto my-4" method="POST" action="dashboard">
                @csrf
                <div class="mb-5">
                ...
                <button type="Login"
                    class="mx-auto mt-12 block text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">Sign
                    in</button>
            </form>
        </div>
    </div>
