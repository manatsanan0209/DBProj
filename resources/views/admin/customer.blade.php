...
<head>
  ...
  <nav class="bg-white dark:bg-gray-900 fixed top-0 w-full z-10">
    ...
    <div class="w-3/5 h-max mt-20 mx-auto p-2 grid grid-cols-2 gap-2">
      <a href="customer" class="dark:text-blue-200 font-normal text-2xl text-center">Customer</a>
      <a href="technician" class="dark:text-white font-normal text-2xl text-center">Technician</a>
